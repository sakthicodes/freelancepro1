<?php
    ...
    if (strlen($_SESSION['id'] == 0)) {
        ...
        exit();
            ...
            $select = "SELECT * FROM admin_detail WHERE id='$id'";
                                        ...
                                        <tbody>
                                            ...
                                            while($array = $process->fetch_array()){?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a style="color:white;text-decoration:none;" href="transactu.php?uid=<?php echo $array['id'];?>">
                                                            <i class="fas fa-pen text-primary mr-3"></i>
                                                    </a>
                                                </td>
                                                    <td style="display: flex;">
                                                        <a style="color:white;text-decoration:none;" href="edituseru.php?uid=<?php echo $array['id'];?>">

	...
	if ($_SERVER['REQUEST_METHOD']=='POST') {
		if (isset($_POST['save'])) {
			...
			if ($stmt->execute()) {
				...
				$count = "SELECT COUNT(id) AS id FROM post_cat";
				...
				$query = "SELECT * FROM post_cat ORDER BY id LIMIT $start,$rpp";
				$stmt = $conn->prepare($query);
				if($stmt->execute()){
								...
								<section id="maincontent">
									...
									<div class="col-md-9">
                                        <div class="card shadow my-3">
                                                <div>
                                                    <p class="list-group-item active">List Of Post Category</p>
                                                </div>
                                                <div class="card-body">
													...
													<?php
														...
														<tbody>
															<tr>
																<?php  $pid = $result['id'];?>
																<td><?php echo $pid; ?></td>
																<td style="width:100%";><?php echo $result['cat_name'];?></td>
																<td style="display:flex;">
																<a style="color:white;text-decoration:none" href="editcat.php?pid=<?php echo $pid;?>">
